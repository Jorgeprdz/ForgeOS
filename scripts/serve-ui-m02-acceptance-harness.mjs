...
server.listen(port, host, () => {
  console.log("UI_M02_STATIC_SERVER=READY");
  console.log(`URL=http://${host}:${port}${defaultDocument}`);
});

const close = () => {
  server.close(() => {
    console.log("UI_M02_STATIC_SERVER=STOPPED");
  });
};
