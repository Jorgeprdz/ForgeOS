...
export default defineConfig({
  testDir: './tests/e2e',
  testMatch: /forge-commercial-compass-015\.spec\.mjs/,
  fullyParallel: false,
  forbidOnly: true,
  retries: 0,
  workers: 1,
  ...
  reporter: [
    ['line'],
    ['json', { outputFile: 'artifacts/forge-commercial-compass-015-playwright.json' }],
  ],
  use: {
    baseURL,
  ...
  webServer: {
    ...
    url: `${baseURL}/tests/e2e/fixtures/forge-commercial-compass-015/index.html`,
