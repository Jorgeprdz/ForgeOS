...
(function forgeProductiveProspectUI067G17B(global) {
  const draftSafetyBoundary = typeof module !== "undefined" && module.exports
    ? require("../../nash/draft-intake/nfast06-draft-safety-boundary.js")
    : global.ForgeDraftSafetyBoundaryNFAST06;
  if (!draftSafetyBoundary) {
    throw new Error("NFAST_06_DRAFT_SAFETY_BOUNDARY_REQUIRED");
  }
  const {
    DRAFT_INTAKE_STATES,
