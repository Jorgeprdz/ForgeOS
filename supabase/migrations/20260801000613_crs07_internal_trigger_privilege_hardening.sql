-- CRS 07 append-only correction: internal lineage triggers need owner privileges
-- to inspect protected Application, Policy, evidence and role tables without
-- granting table SELECT to authenticated callers.
-- Migrations 00610 through 00612 remain immutable in remote history.
