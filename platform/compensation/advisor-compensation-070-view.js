...
export const ADVISOR_COMPENSATION_070_STYLES = `<style data-advisor-compensation-style="070">
  .comp-shell{--comp-surface:color-mix(in srgb,var(--card-bg,#fff) 94%,transparent);display:grid;gap:18px;padding:clamp(16px,3vw,28px);padding-bottom:calc(104px + env(safe-area-inset-bottom));max-width:1320px;margin:0 auto;color:var(--text,#17202a)}
  ...
  .comp-source-health{display:flex;gap:8px;flex-wrap:wrap}.comp-source-health span{font-size:.74rem;padding:6px 9px;border-radius:999px;background:var(--comp-surface);border:1px solid var(--separator,#d7dce5)}
  .comp-banner{padding:12px 14px;border-radius:14px;font-weight:650}.comp-banner--warning{background:#fff4d5;color:#6d4a00}
  .comp-hero{display:grid;grid-template-columns:minmax(0,1fr) minmax(240px,.55fr);gap:18px;padding:22px;border-radius:24px;background:linear-gradient(135deg,color-mix(in srgb,var(--accent,#5b5bd6) 16%,var(--comp-surface)),var(--comp-surface));border:1px solid color-mix(in srgb,var(--accent,#5b5bd6) 26%,transparent)}
  .comp-hero>div{display:flex;gap:10px;align-items:baseline;flex-wrap:wrap}.comp-hero strong{font-size:clamp(2rem,6vw,4rem);line-height:1}.comp-hero p{margin:auto 0;color:var(--muted,#657085)}
  ...
  .comp-card{padding:17px;min-height:148px}.comp-card__heading{display:flex;justify-content:space-between;gap:8px;align-items:center;font-weight:760}.comp-card strong{display:block;font-size:clamp(1.35rem,3vw,2rem);margin:17px 0 7px}.comp-card p{margin:0;color:var(--muted,#657085);font-size:.84rem;line-height:1.4}
  ...
  .comp-section{padding:20px}.comp-section header{display:flex;justify-content:space-between;align-items:center;margin-bottom:16px}
  .comp-history__chart{display:grid;grid-template-columns:repeat(6,minmax(78px,1fr));gap:10px;min-height:250px;align-items:end;overflow-x:auto;padding:14px 2px 4px}.comp-history__column{display:grid;grid-template-rows:auto 150px auto auto;gap:7px;justify-items:center;min-width:78px}.comp-history__value{font-size:.69rem;font-weight:750;white-space:nowrap}.comp-history__bar{width:min(48px,70%);height:var(--comp-bar);align-self:end;border-radius:12px 12px 4px 4px;background:linear-gradient(180deg,var(--accent,#5b5bd6),color-mix(in srgb,var(--accent,#5b5bd6) 45%,#70d6ff));min-height:4px}.comp-history__label{font-size:.75rem;font-weight:850}
  .comp-details{display:grid;gap:10px}.comp-detail{border:1px solid var(--separator,#d7dce5);border-radius:16px;padding:0 14px}.comp-detail summary{display:flex;justify-content:space-between;gap:12px;align-items:center;cursor:pointer;padding:14px 0}.comp-detail summary span:first-child{display:grid;gap:3px}.comp-detail small{color:var(--muted,#657085)}.comp-detail dl{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin:0 0 12px}.comp-detail dl div{padding:9px;border-radius:10px;background:color-mix(in srgb,var(--comp-surface) 80%,var(--separator,#d7dce5))}.comp-detail dt{font-size:.68rem;text-transform:uppercase;color:var(--muted,#657085)}.comp-detail dd{margin:4px 0 0;overflow-wrap:anywhere}.comp-detail__explanation{font-size:.82rem;color:var(--muted,#657085)}
  ...
  .comp-state{display:flex;gap:16px;align-items:center;padding:28px;min-height:220px}.comp-state__icon{font-size:2.3rem}.comp-state h2{margin:0 0 6px}.comp-state p{margin:0;color:var(--muted,#657085)}.comp-state code{display:block;margin-top:10px;overflow-wrap:anywhere}
  ...
  @media(max-width:620px){.comp-shell{padding:14px;padding-bottom:calc(112px + env(safe-area-inset-bottom))}.comp-header{align-items:flex-start;flex-direction:column}.comp-period-nav{width:100%}.comp-period-nav button{flex:1}.comp-grid{grid-template-columns:1fr}.comp-card{min-height:auto}.comp-simulator{align-items:flex-start;flex-direction:column}.comp-hero strong{width:100%}}
</style>`;
