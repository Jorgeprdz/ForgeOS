...
```json
{
  ...
  "base_readiness_gate": "parser_ownership_resolved",
  "base_readiness_gate_status": "decision_required",
  "base_readiness_decision": "review_required",
  "overall_readiness_before_083a": "not_ready_for_execution",
  "expected_trace_registry_status_before_083a": "not_bound_not_verified_not_ready",
