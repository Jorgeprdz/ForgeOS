...
```json
{
  ...
  "safe_ux_state_status_before_087a": "safe_state_model_mapped_no_effects",
  "preview_vs_quote_truth_boundary_status_before_087a": "preview_boundary_mapped_quote_truth_blocked",
  "component_count": 8,
  "components": [
    {
