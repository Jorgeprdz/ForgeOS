  ...
  "provenance_rules": [
    {
      ...
      "provenance_type": "fixture_text_provenance",
    ...
    },
    {
      ...
      "provenance_type": "governance_assertion_provenance",
    ...
    },
    {
      ...
      "provenance_type": "real_pdf_file_provenance",
    ...
    },
    {
      ...
      "provenance_type": "rate_cache_provenance",
      "required_status": "cache_or_metadata_only_until_runtime_gate",
      "blocked_misuse": [
        "provider_runtime_without_gate",
        "network_call_without_gate",
        "secret_access_without_gate"
      ]
    },
    {
      ...
      "provenance_type": "deterministic_input_provenance",
      "required_status": "input_source_required",
      "blocked_misuse": [
        "invented_udi_growth",
        "invented_current_udi",
        "untraceable_projection_inputs"
      ]
    },
    {
      ...
      "provenance_type": "engine_reference_provenance",
  ...
  "provenance_scope_entries": [
    {
      ...
      "execution_policy": "not_executed_in_registry",
      "provenance_required": true,
      "provenance_rules": [
        "real_pdf_tests_require_file_provenance",
        "engine_reference_must_be_existing_surface"
      ],
    ...
    },
    {
      ...
      "execution_policy": "requires_expected_value_provenance_review",
      "provenance_required": true,
      "provenance_rules": [
        "expected_values_require_source_trace",
        "engine_reference_must_be_existing_surface"
      ],
      "expected_provenance_types": [
    ...
    },
    {
      ...
      "provenance_rules": [
        "expected_values_require_source_trace",
        "real_pdf_tests_require_file_provenance",
        "deterministic_inputs_required_for_projection",
        "engine_reference_must_be_existing_surface"
      ],
      "expected_provenance_types": [
        "expected_value_provenance",
    ...
    },
    {
      ...
      "evidence_type": "imagina_ser_flow",
      "canonical_status": "canonical_decision_required",
      "evidence_role": "candidate Imagina Ser flow evidence after provider/cache boundary review",
      "execution_policy": "requires_future_runtime_gate",
      "provenance_required": true,
      "provenance_rules": [
        "banxico_cache_requires_runtime_boundary",
        "engine_reference_must_be_existing_surface"
      ],
      "expected_provenance_types": [
    ...
    },
    {
      ...
      "evidence_type": "rate_cache_metadata",
      "canonical_status": "secondary_or_decision_required",
    ...
    },
    {
      ...
      "evidence_type": "deterministic_projection_smoke",
      "canonical_status": "supporting_candidate",
    ...
    },
    {
      ...
      "canonical_status": "fixture_evidence_only",
      "evidence_role": "preview fixture evidence only; not proof of real PDF/OCR extraction",
      "execution_policy": "requires_fixture_provenance_review",
      "provenance_required": true,
      "provenance_rules": [
        "fixture_not_real_pdf_evidence",
        "engine_reference_must_be_existing_surface"
      ],
      "expected_provenance_types": [
    ...
    },
    {
      ...
      "canonical_status": "governance_evidence_only",
      "evidence_role": "governance evidence only; validates no-effect promotion guardrail, not extraction",
      "execution_policy": "safe_guardrail_test_only",
      "provenance_required": true,
      "provenance_rules": [
        "governance_not_extraction_proof",
        "engine_reference_must_be_existing_surface"
      ],
      "expected_provenance_types": [
...
- `python3 -m json.tool docs/evidence/forge-quote-preview-pdf-engine-canonical-test-evidence-provenance-scope-audit-079a.json`
- marker scan
- `git diff --check`
- scoped safety scan
