# ADR: Quote Preview PDF Runtime Persistence

- **Identifier:** `QUOTE_PREVIEW_PDF_RUNTIME_PERSISTENCE`
- **Status:** `ACCEPTED`
- **Approved:** `true`
- **Numeric ADR assigned:** `false`
- **Approval authority:** `USER_PROJECT_OWNER`
- **Approval gate:** `107Z9`
- **Approved local stamp:** `20260710_000129`
- **Implementation authorized:** `false`

> This ADR is approved as the direct architectural authority for the bounded
> Quote Preview PDF result-persistence contract. Approval does not authorize
> implementation, runtime writes, UI integration or quote truth.
...
This approval accepts the architecture decision. Implementation remains separately gated and unauthorized.
