...
FIRST_VERTICAL_EVENT_TYPES=PRESERVED
...
TIMELINE_TO_PROJECTION_RUNTIME=PASS
BLOCKED_OBSERVATIONS_EXPLICIT=PASS
HANDOFF_PROMOTION=NO
PIPELINE_STAGE_PROMOTION=NO
...
PERMISSION_EXPLANATION_RUNTIME=YES
INTERNAL_TARGET_RUNTIME=YES
SCHEDULER_INTENT_RUNTIME=YES
RETRY_RUNTIME=BOUNDED
DEDUPLICATION_RUNTIME=DETERMINISTIC
INTERNAL_FALLBACK_RUNTIME=EXPLICIT
PUSH_EXECUTION=NO
PERMISSION_PROMPT_EXECUTION=NO
SUBSCRIPTION_REGISTRATION=NO
SERVICE_WORKER_MUTATION=NO
...
ACTIVITY_PERSISTENCE=FES_02_LOCAL_FIRST_RPC_ONLY
PROJECTION_LINEAGE=ACTIVITY_PROSPECT_PIPELINE_MI_DIA
HANDOFF_IS_RESULT=NO
HUMAN_CONFIRMATION_REQUIRED=YES
PERFORMANCE_WRITE=FORBIDDEN
