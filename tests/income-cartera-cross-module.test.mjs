...
const v5 = read("docs/static-preview/forge-aura/cartera/cartera-adapter-pages-v5.js");
...
test("Cartera v5 preserves the governed v4 to v3 to authenticated v2 Functions invoke transport chain", () => {
