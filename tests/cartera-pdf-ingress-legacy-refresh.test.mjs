...
test('canonical Aura import graph preserves v9 ingress and v10 durable confirmation under the v11 read-projection descendant', () => {
  assert.match(index, /"\.\/cartera\/cartera-adapter-pages-v9\.js\?v=cartera-pdf-ingress-legacy-refresh": "\.\/cartera\/cartera-adapter-pages-v11\.js\?v=cartera-person-workspace-directory-projection-016"/);
