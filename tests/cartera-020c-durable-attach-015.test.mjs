...
const module002 = await readFile(new URL('../docs/static-preview/forge-aura/cartera/cartera-module-v14-hotfix002.js', import.meta.url), 'utf8');
const module002Core = await readFile(new URL('../docs/static-preview/forge-aura/cartera/cartera-module-hotfix002.js', import.meta.url), 'utf8');
...
test('Aura productive import map reaches durable v10 through Hotfix002, additive 017E, current v13 adapter chain and 015 wrapper', () => {
  ...
  assert.match(index, /"\.\/cartera\/cartera-module\.js\?v=aura-cartera-pdf-auth-002": "\.\/cartera\/cartera-module-v14-hotfix002\.js\?v=post017e-hotfix002"/);
  assert.match(module002, /cartera-module-hotfix002-entry\.js\?v=post017e-hotfix002/);
  assert.match(module002Core, /cartera-module-v13-017e\.js\?v=post017e-hotfix001/);
