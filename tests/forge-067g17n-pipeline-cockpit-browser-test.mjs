...
try {
  ...
  assert.equal(await page.$eval("[data-message-editor]", node => !node.hidden), true);
  await page.click("[data-edit-message]");
  await page.click("[data-approve-whatsapp-draft]");
